...
codons <- c("AAA","AAC", "AAG", "AAT", "ACA", "ACC", "ACG", "ACT", "AGA", "AGG", "ATA", "ATC","ATG", "ATT", "CAA", "CAC", "CAG", "CAT","CCA","CCC","CCG","CCT", "CGA", "CGC", "CGG", "CGT", "CTA", "CTC", "CTG", "CTT", "GAA", "GAC", "GAG", "GAT", "GCA", "GCC", "GCG", "GCT", "GGA", "GGC", "GGG", "GGT", "GTA", "GTC", "GTG", "GTT", "TAC", "TAT","TCA", "TCC", "TCG", "TCT","TGC", "TGG", "TGT", "TTA", "TTC","TTG", "TTT" )

std <- c("K", "N", "K", "N", "T", "T", "T", "T", "R", "R", "I", "I",
         "M", "I", "Q", "H", "Q", "H", "P", "P", "P", "P", "R", "R", "R", "R",
         "L", "L", "L", "L", "E", "D", "E", "D", "A", "A", "A", "A", "G",
         "G", "G", "G","V", "V", "V", "V", "Y", "Y", "S", "S", "S", "S", "C",
         "W", "C", "L", "F", "L", "F")

aa <- c("KR", "NY", "KR", "NY", "TR", "TY", "TR", "TY", "RR", "RR", "IR", "IY",
...
if(is.null(aa.to.codon.table)) {
  ...
  localAAToCodon <- function(aa, focal = FALSE) {
    ...
    #check codons is same as default
    aa.def <- codonToAA(codons[1])
    codon.def <- AAToCodon(aa.def)
    if(codon.def !%in% codons) {
      warning("Error: codons not found in default codon list",
              call. = TRUE, immediate. = FALSE, noBreaks. = FALSE,
              domain = NULL)
    }
    #if focal = false, drop alphabetically last codon or
    ## better, use codons %in% AAToCodon(aa, focal = TRUE) to figure out which is focal
    return(codons)
    }
  }
