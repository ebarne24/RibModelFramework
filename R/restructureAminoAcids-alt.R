...
plotCodonSpecificParameters(trace = trace, mixture = 1, type = "Mutation", main = "Mutation Parameter Traces", ROC.or.FONSE = TRUE)

pdf("CSPtest.pdf")
plotCodonSpecificParameters(trace = trace, mixture = 1, type = "Mutation", main = "Mutation Parameter Traces", ROC.or.FONSE = TRUE, aa.names = c("CY", "DY", "FY"))
dev.off()
